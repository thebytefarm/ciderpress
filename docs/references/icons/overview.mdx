...
<table>
  ...
  <tbody>
    ...
    <tr>
      <td style={{ textAlign: 'center' }}>
        <Icon icon="pixel:slack" width={20} height={20} />
      </td>
      <td>
        <code>pixel</code>
      </td>
      <td>
        <a href="https://icon-sets.iconify.design/pixel/">Pixel Icons</a>
      </td>
      <td>Social/brand glyphs, pixel-art UI</td>
    </tr>
    <tr>
      <td style={{ textAlign: 'center' }}>
...
- **pixel** — [icon-sets.iconify.design/pixel/](https://icon-sets.iconify.design/pixel/)
