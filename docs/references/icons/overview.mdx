...
import { Icon } from '@ciderpress/ui/theme'
...
<table>
  ...
  <tbody>
    <tr>
      ...
      <td>Sidebar icons, UI chrome</td>
    </tr>
    <tr>
      <td style={{ textAlign: 'center' }}>
        <Icon icon="devicon:typescript" width={20} height={20} />
      </td>
      <td>
        <code>devicon</code>
      </td>
      ...
      <td>Developer tools, colored logos</td>
    </tr>
    <tr>
      <td style={{ textAlign: 'center' }}>
        <Icon icon="simple-icons:react" width={20} height={20} />
      </td>
      <td>
      ...
      <td>Brand icons, tech tags (monochrome)</td>
    </tr>
    <tr>
      <td style={{ textAlign: 'center' }}>
      ...
      <td>General-purpose UI icons</td>
    </tr>
    <tr>
      <td style={{ textAlign: 'center' }}>
        <Icon icon="catppuccin:typescript" width={20} height={20} />
      </td>
      <td>
        <code>catppuccin</code>
      </td>
      <td>
        <a href="https://github.com/catppuccin">Catppuccin Icons</a>
      </td>
      <td>File type icons, themed accents</td>
    </tr>
    <tr>
      <td style={{ textAlign: 'center' }}>
        <Icon icon="skill-icons:typescript" width={20} height={20} />
      </td>
      <td>
        <code>skill-icons</code>
      </td>
      <td>
        <a href="https://skillicons.dev">Skill Icons</a>
      </td>
      <td>Skill badges, colored tech logos</td>
    </tr>
    <tr>
      <td style={{ textAlign: 'center' }}>
        <Icon icon="logos:hono" width={20} height={20} />
      </td>
      <td>
        <code>logos</code>
      </td>
      ...
      <td>Colored brand logos (fallback)</td>
    </tr>
    <tr>
      <td style={{ textAlign: 'center' }}>
        <Icon icon="vscode-icons:file-type-shadcn" width={20} height={20} />
      </td>
      <td>
        <code>vscode-icons</code>
      </td>
      <td>
        <a href="https://github.com/vscode-icons/vscode-icons">VS Code Icons</a>
      </td>
      <td>File type icons</td>
    </tr>
    <tr>
      <td style={{ textAlign: 'center' }}>
        <Icon icon="material-icon-theme:trigger" width={20} height={20} />
      </td>
      <td>
        <code>material-icon-theme</code>
      </td>
      <td>
        <a href="https://github.com/material-extensions/vsc-material-icon-theme">
          Material Icon Theme
        </a>
      </td>
      <td>Material file/folder icons</td>
    </tr>
  </tbody>
</table>
...
Only top-level sections render icons in the sidebar rail. Icons set on nested (child) sections are ignored.
...
Workspace items display an icon on their home page card and landing page:
...
Workspace cards display technology tags with auto-resolved icons. See the [Technology Tags](/reference/technology) reference for the full list of supported tag names.
